...
手上會拿到一個**有顏色的包裹**,送到**同色的信箱**(顏色不符不會收件)。頭上的箭頭會指向目標,計時越快星級越高,最佳成績存於瀏覽器 `localStorage`。送完 5 件過關。村莊之間有沙土小路相連。

遊戲有**程序化音樂與音效**(純合成、無音檔),右上「🔊 聲音」可靜音;跳躍/落地有壓扁拉伸與塵土、投遞有彩帶等 juice 效果。
